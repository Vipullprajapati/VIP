...
export function CartShopping({cart}) {
    ...
    return (
        <>
            <div onClick={closeCartOnBg} dataset='box-cart' style={{backgroundColor: 'rgba(111, 128, 107, 0.5)'}} className='fixed left-0 top-0 right-0 bottom-0 z-[1] flex flex-col items-center justify-center shadow-2xl'>
